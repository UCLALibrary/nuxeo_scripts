...
#It also requires Python 3 and the pandas library: ****pip install pandas****
#It also assumes that columns with numbers are set and not changed
#Written by Niqui O'Neill
#Running the script will prompt for the path to the directory containing the TSV and columns.tx file.
